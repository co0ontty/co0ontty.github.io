...
登陆Discuz!X搭建的论坛，注册账号，在个人设置界面使用POST发送请求：
...
其中formhash的值为：
![屏幕快照 2019-06-14 13.39.01.png](https://i.loli.net/2019/06/14/5d0334e5b240c14832.png)
发送请求后即刻删除指定的文件:
![屏幕快照 2019-06-14 13.46.55.png](https://i.loli.net/2019/06/14/5d0334e65501c75422.png)
...
· 构造可执行命令的序列化对象  
这里使用的是jmet[下载地址](https://github.com/matthiaskaiser/jmet/releases/download/0.1.0/jmet-0.1.0-all.jar)，jmet原理是使用ysoserial生成Payload并发送（其jar内自带ysoserial，无需再自己下载），所以我们需要在ysoserial是gadget中选择一个可以使用的，比如ROME。也可以单独使用ysoserial并发送。需要注意的是，使用jmet的时候需要在统计目录中创建一个名为external的文件夹，否则可能报文件夹不存在的错误
· 构造消息传递给目标的61616端口  
...
![屏幕快照 2019-06-15 09.26.56.png](https://i.loli.net/2019/06/15/5d04559c3e45c87197.png)

· 使用管理员账号登陆管理界面，http://your-ip:8161/admin/browse.jsp? 点击查看消息详情，出发命令执行。 

![5d0456dc7307223516](https://i.loli.net/2019/06/15/5d0456dc7307223516.png)

· 进入docker查看文件创建情况

![5d04573291c4e85321](https://i.loli.net/2019/06/15/5d04573291c4e85321.png)

· 将运行的命令切换为反弹 shell的命令即可获得目标的shell
